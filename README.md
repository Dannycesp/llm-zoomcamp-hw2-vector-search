...
In this [homework](https://github.com/DataTalksClub/llm-zoomcamp/blob/main/cohorts/2025/02-vector-search/homework.md), we will learn more about vector search
...
* [Solutions](vector_search_solutions.ipynb)
